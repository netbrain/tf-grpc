...
func (*VarLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ec40ba418c414527, []int{0}
}
...
func (*FixedLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ec40ba418c414527, []int{1}
}
...
func (*FeatureConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ec40ba418c414527, []int{2}
}
...
func (*ExampleParserConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ec40ba418c414527, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/example/example_parser_configuration.proto", fileDescriptor_example_parser_configuration_ec40ba418c414527)
}

var fileDescriptor_example_parser_configuration_ec40ba418c414527 = []byte{
