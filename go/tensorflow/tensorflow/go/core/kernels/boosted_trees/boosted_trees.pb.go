...
package boosted_trees // import "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/kernels/boosted_trees"
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{0}
}
...
func _Node_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Node_BucketizedSplit:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.BucketizedSplit); err != nil {
			return err
		}
	case *Node_CategoricalSplit:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CategoricalSplit); err != nil {
			return err
		}
	case *Node_DenseSplit:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.DenseSplit); err != nil {
			return err
		}
	case nil:
	default:
...
func _Node_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // node.leaf
		...
		m.Node = &Node_Leaf{msg}
		return true, err
	case 2: // node.bucketized_split
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BucketizedSplit)
		err := b.DecodeMessage(msg)
		m.Node = &Node_BucketizedSplit{msg}
		return true, err
	case 3: // node.categorical_split
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CategoricalSplit)
		err := b.DecodeMessage(msg)
		m.Node = &Node_CategoricalSplit{msg}
		return true, err
	case 4: // node.dense_split
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DenseSplit)
		err := b.DecodeMessage(msg)
		m.Node = &Node_DenseSplit{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Node_OneofSizer(msg proto.Message) (n int) {
	...
	case *Node_Leaf:
		...
		n += s
	case *Node_BucketizedSplit:
		s := proto.Size(x.BucketizedSplit)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Node_CategoricalSplit:
		s := proto.Size(x.CategoricalSplit)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Node_DenseSplit:
		s := proto.Size(x.DenseSplit)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*NodeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{1}
}
...
func (*Leaf) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{2}
}
...
func (*Vector) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{3}
}
...
func (*SparseVector) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{4}
}
...
func (dst *SparseVector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SparseVector.Merge(dst, src)
}
...
func (*BucketizedSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{5}
}
...
func (dst *BucketizedSplit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BucketizedSplit.Merge(dst, src)
}
...
func (*CategoricalSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{6}
}
...
func (dst *CategoricalSplit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CategoricalSplit.Merge(dst, src)
}
...
func (*DenseSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{7}
}
...
func (dst *DenseSplit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DenseSplit.Merge(dst, src)
}
...
func (*Tree) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{8}
}
...
func (*TreeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{9}
}
...
func (dst *TreeMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TreeMetadata.Merge(dst, src)
}
...
func (*TreeMetadata_PostPruneNodeUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{9, 0}
}
...
func (dst *TreeMetadata_PostPruneNodeUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TreeMetadata_PostPruneNodeUpdate.Merge(dst, src)
}
...
func (*GrowingMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{10}
}
...
func (dst *GrowingMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GrowingMetadata.Merge(dst, src)
}
...
func (*TreeEnsemble) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{11}
}
...
func (dst *TreeEnsemble) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TreeEnsemble.Merge(dst, src)
}
...
func (*DebugOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_boosted_trees_8f3dbbd52693c4be, []int{12}
}
...
func (dst *DebugOutput) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DebugOutput.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/kernels/boosted_trees/boosted_trees.proto", fileDescriptor_boosted_trees_8f3dbbd52693c4be)
}

var fileDescriptor_boosted_trees_8f3dbbd52693c4be = []byte{
