...
func (*TFProfTensorProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_output_fcf11595c95adda0, []int{0}
}
...
func (dst *TFProfTensorProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TFProfTensorProto.Merge(dst, src)
}
...
func (*GraphNodeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_output_fcf11595c95adda0, []int{1}
}
...
func (dst *GraphNodeProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphNodeProto.Merge(dst, src)
}
...
func (*MultiGraphNodeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_output_fcf11595c95adda0, []int{2}
}
...
func (dst *MultiGraphNodeProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiGraphNodeProto.Merge(dst, src)
}
...
func (*AdviceProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_output_fcf11595c95adda0, []int{3}
}
...
func (dst *AdviceProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdviceProto.Merge(dst, src)
}
...
func (*AdviceProto_Checker) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_output_fcf11595c95adda0, []int{3, 1}
}
...
func (dst *AdviceProto_Checker) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdviceProto_Checker.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/profiler/tfprof_output.proto", fileDescriptor_tfprof_output_fcf11595c95adda0)
}

var fileDescriptor_tfprof_output_fcf11595c95adda0 = []byte{
