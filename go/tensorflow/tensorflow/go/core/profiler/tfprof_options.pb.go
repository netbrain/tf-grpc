...
func (*OptionsProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_34d263e381dc9eb7, []int{0}
}
...
func (m *OptionsProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OptionsProto.Merge(m, src)
}
...
func (*AdvisorOptionsProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_34d263e381dc9eb7, []int{1}
}
...
func (m *AdvisorOptionsProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdvisorOptionsProto.Merge(m, src)
}
...
func (*AdvisorOptionsProto_CheckerOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_34d263e381dc9eb7, []int{1, 1}
}
...
func (m *AdvisorOptionsProto_CheckerOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdvisorOptionsProto_CheckerOption.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/profiler/tfprof_options.proto", fileDescriptor_34d263e381dc9eb7)
}

var fileDescriptor_34d263e381dc9eb7 = []byte{
