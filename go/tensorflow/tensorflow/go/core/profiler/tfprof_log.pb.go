...
func (*CodeDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{0}
}
...
func (dst *CodeDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CodeDef.Merge(dst, src)
}
...
func (*CodeDef_Trace) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{0, 0}
}
...
func (dst *CodeDef_Trace) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CodeDef_Trace.Merge(dst, src)
}
...
func (*OpLogEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{1}
}
...
func (dst *OpLogEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpLogEntry.Merge(dst, src)
}
...
func (*OpLogProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{2}
}
...
func (dst *OpLogProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpLogProto.Merge(dst, src)
}
...
func (*ProfileProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{3}
}
...
func (dst *ProfileProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProfileProto.Merge(dst, src)
}
...
func (*ProfileNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{4}
}
...
func (dst *ProfileNode) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProfileNode.Merge(dst, src)
}
...
func (*ExecProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{5}
}
...
func (dst *ExecProfile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecProfile.Merge(dst, src)
}
...
func (*ExecTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{6}
}
...
func (dst *ExecTime) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecTime.Merge(dst, src)
}
...
func (*ExecMemory) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{7}
}
...
func (dst *ExecMemory) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecMemory.Merge(dst, src)
}
...
func (*Tuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{8}
}
...
func (*Memory) Descriptor() ([]byte, []int) {
	return fileDescriptor_tfprof_log_ded4e5d5b9d873ca, []int{9}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/profiler/tfprof_log.proto", fileDescriptor_tfprof_log_ded4e5d5b9d873ca)
}

var fileDescriptor_tfprof_log_ded4e5d5b9d873ca = []byte{
