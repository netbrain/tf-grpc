...
import fmt "fmt"
import math "math"
import example "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/example"
...
func (*ExampleWithExtras) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_proto_fast_parsing_test_5e574fc117269793, []int{0}
}
...
func (dst *ExampleWithExtras) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExampleWithExtras.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/util/example_proto_fast_parsing_test.proto", fileDescriptor_example_proto_fast_parsing_test_5e574fc117269793)
}

var fileDescriptor_example_proto_fast_parsing_test_5e574fc117269793 = []byte{
