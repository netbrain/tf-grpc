...
import profiler "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/profiler"
import protobuf "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/protobuf"
import util "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/util"
...
func (EventReply_DebugOpStateChange_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_debug_service_7ffbb444dc05a5c4, []int{0, 0, 0}
}
...
func (CallTraceback_CallType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_debug_service_7ffbb444dc05a5c4, []int{1, 0}
}
...
func (*EventReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_service_7ffbb444dc05a5c4, []int{0}
}
...
func (*EventReply_DebugOpStateChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_service_7ffbb444dc05a5c4, []int{0, 0}
}
...
func (dst *EventReply_DebugOpStateChange) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventReply_DebugOpStateChange.Merge(dst, src)
}
...
func (*CallTraceback) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_service_7ffbb444dc05a5c4, []int{1}
}
...
func (dst *CallTraceback) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CallTraceback.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/debug/debug_service.proto", fileDescriptor_debug_service_7ffbb444dc05a5c4)
}

var fileDescriptor_debug_service_7ffbb444dc05a5c4 = []byte{
