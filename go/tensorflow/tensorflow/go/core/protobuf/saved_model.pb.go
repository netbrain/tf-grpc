...
func (*SavedModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_saved_model_afec8f4a421d31cb, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saved_model.proto", fileDescriptor_saved_model_afec8f4a421d31cb)
}

var fileDescriptor_saved_model_afec8f4a421d31cb = []byte{
