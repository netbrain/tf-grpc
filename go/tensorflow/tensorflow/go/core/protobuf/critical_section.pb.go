...
func (*CriticalSectionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_cca3b41efce2965d, []int{0}
}
...
func (*CriticalSectionExecutionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_cca3b41efce2965d, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/critical_section.proto", fileDescriptor_critical_section_cca3b41efce2965d)
}

var fileDescriptor_critical_section_cca3b41efce2965d = []byte{
