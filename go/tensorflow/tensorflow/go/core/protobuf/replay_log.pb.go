...
import fmt "fmt"
import math "math"
import _ "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/core/framework"
...
func (*NewReplaySession) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_28b080992a8c608d, []int{0}
}
...
func (*ReplayOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_28b080992a8c608d, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/replay_log.proto", fileDescriptor_replay_log_28b080992a8c608d)
}

var fileDescriptor_replay_log_28b080992a8c608d = []byte{
