...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_e1219dc412040711, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_e1219dc412040711, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_e1219dc412040711)
}

var fileDescriptor_saver_e1219dc412040711 = []byte{
