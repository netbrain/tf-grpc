...
func (*QueueRunnerDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_runner_bd1f3f4a2235ffb8, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/queue_runner.proto", fileDescriptor_queue_runner_bd1f3f4a2235ffb8)
}

var fileDescriptor_queue_runner_bd1f3f4a2235ffb8 = []byte{
