...
func (*DebugTensorWatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_f774af7df48d8183, []int{0}
}
...
func (*DebugOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_f774af7df48d8183, []int{1}
}
...
func (*DebuggedSourceFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_f774af7df48d8183, []int{2}
}
...
func (*DebuggedSourceFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_f774af7df48d8183, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/debug.proto", fileDescriptor_debug_f774af7df48d8183)
}

var fileDescriptor_debug_f774af7df48d8183 = []byte{
	// 497 bytes of a gzipped FileDescriptorProto
	,
}
