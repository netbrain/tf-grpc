...
func (*ValuesDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_control_flow_96f54fb71991638a, []int{0}
}
...
func (*ControlFlowContextDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_control_flow_96f54fb71991638a, []int{1}
}
...
func (*CondContextDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_control_flow_96f54fb71991638a, []int{2}
}
...
func (*WhileContextDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_control_flow_96f54fb71991638a, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/control_flow.proto", fileDescriptor_control_flow_96f54fb71991638a)
}

var fileDescriptor_control_flow_96f54fb71991638a = []byte{
	// 638 bytes of a gzipped FileDescriptorProto
	,
}
