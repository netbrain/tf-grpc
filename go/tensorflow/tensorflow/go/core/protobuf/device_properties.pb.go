...
func (*DeviceProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_99d403251fefdbc3, []int{0}
}
...
func (*NamedDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_99d403251fefdbc3, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_properties.proto", fileDescriptor_device_properties_99d403251fefdbc3)
}

var fileDescriptor_device_properties_99d403251fefdbc3 = []byte{
