...
func (*TensorDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_description_e3e8a6301154f38b, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor_tensor_description_e3e8a6301154f38b)
}

var fileDescriptor_tensor_description_e3e8a6301154f38b = []byte{
