...
func (*VariableDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_db1e53c430f07bbc, []int{0}
}
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_db1e53c430f07bbc, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor_variable_db1e53c430f07bbc)
}

var fileDescriptor_variable_db1e53c430f07bbc = []byte{
