...
func (*OpDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_0e205cbe3483cc7f, []int{0}
}
...
func (*OpDef_ArgDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_0e205cbe3483cc7f, []int{0, 0}
}
...
func (*OpDef_AttrDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_0e205cbe3483cc7f, []int{0, 1}
}
...
func (*OpDeprecation) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_0e205cbe3483cc7f, []int{1}
}
...
func (*OpList) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_0e205cbe3483cc7f, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/op_def.proto", fileDescriptor_op_def_0e205cbe3483cc7f)
}

var fileDescriptor_op_def_0e205cbe3483cc7f = []byte{
	...
	,
}
