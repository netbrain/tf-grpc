...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_b4b06bfd5e7203fe, []int{0}
}
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_b4b06bfd5e7203fe, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor_tensor_shape_b4b06bfd5e7203fe)
}

var fileDescriptor_tensor_shape_b4b06bfd5e7203fe = []byte{
