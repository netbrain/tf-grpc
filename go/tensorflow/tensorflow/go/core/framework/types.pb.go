...
func (DataType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_570d48558d4103aa, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/types.proto", fileDescriptor_types_570d48558d4103aa)
}

var fileDescriptor_types_570d48558d4103aa = []byte{
