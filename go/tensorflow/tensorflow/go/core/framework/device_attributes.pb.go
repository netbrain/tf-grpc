...
func (*InterconnectLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_627f6aa6b62d63d1, []int{0}
}
...
func (*LocalLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_627f6aa6b62d63d1, []int{1}
}
...
func (*DeviceLocality) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_627f6aa6b62d63d1, []int{2}
}
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_627f6aa6b62d63d1, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/device_attributes.proto", fileDescriptor_device_attributes_627f6aa6b62d63d1)
}

var fileDescriptor_device_attributes_627f6aa6b62d63d1 = []byte{
