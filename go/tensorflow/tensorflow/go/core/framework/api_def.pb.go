...
func (ApiDef_Visibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_def_0a851563f2455fa3, []int{0, 0}
}
...
func (*ApiDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_0a851563f2455fa3, []int{0}
}
...
func (*ApiDef_Arg) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_0a851563f2455fa3, []int{0, 1}
}
...
func (*ApiDef_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_0a851563f2455fa3, []int{0, 2}
}
...
func (*ApiDefs) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_0a851563f2455fa3, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/api_def.proto", fileDescriptor_api_def_0a851563f2455fa3)
}

var fileDescriptor_api_def_0a851563f2455fa3 = []byte{
	// 620 bytes of a gzipped FileDescriptorProto
	,
}
