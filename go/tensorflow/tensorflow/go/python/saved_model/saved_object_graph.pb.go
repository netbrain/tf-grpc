...
func (*SavedObjectGraph) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{0}
}
...
func (*SavedObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{1}
}
...
func (*SavedUserObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{2}
}
...
func (*SavedAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{3}
}
...
func (*SavedPolymorphicFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{4}
}
...
func (m *SavedPolymorphicFunction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SavedPolymorphicFunction.Merge(m, src)
}
...
func (*SavedMonomorphicFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e21737faa7cdbbb, []int{5}
}
...
func (m *SavedMonomorphicFunction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SavedMonomorphicFunction.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/python/saved_model/saved_object_graph.proto", fileDescriptor_5e21737faa7cdbbb)
}

var fileDescriptor_5e21737faa7cdbbb = []byte{
