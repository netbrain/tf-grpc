...
package framework // import "github.com/netbrain/tf-grpc/go/tensorflow/tensorflow/go/python/framework"
...
func (*CppShapeInferenceResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_cpp_shape_inference_07abac3cbf4b2679, []int{0}
}
...
func (dst *CppShapeInferenceResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CppShapeInferenceResult.Merge(dst, src)
}
...
func (*CppShapeInferenceResult_HandleShapeAndType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cpp_shape_inference_07abac3cbf4b2679, []int{0, 0}
}
...
func (dst *CppShapeInferenceResult_HandleShapeAndType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CppShapeInferenceResult_HandleShapeAndType.Merge(dst, src)
}
...
func (*CppShapeInferenceResult_HandleData) Descriptor() ([]byte, []int) {
	return fileDescriptor_cpp_shape_inference_07abac3cbf4b2679, []int{0, 1}
}
...
func (dst *CppShapeInferenceResult_HandleData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CppShapeInferenceResult_HandleData.Merge(dst, src)
}
...
func (*CppShapeInferenceInputsNeeded) Descriptor() ([]byte, []int) {
	return fileDescriptor_cpp_shape_inference_07abac3cbf4b2679, []int{1}
}
...
func (dst *CppShapeInferenceInputsNeeded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CppShapeInferenceInputsNeeded.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/python/framework/cpp_shape_inference.proto", fileDescriptor_cpp_shape_inference_07abac3cbf4b2679)
}

var fileDescriptor_cpp_shape_inference_07abac3cbf4b2679 = []byte{
