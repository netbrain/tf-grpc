...
func (Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{0}
}
...
func (*Medium) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{1}
}
...
func (*Medium_GroupA) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{1, 0}
}
...
func (m *Medium_GroupA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Medium_GroupA.Merge(m, src)
}
...
func (*Medium_GroupA_GroupB) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{1, 0, 0}
}
...
func (m *Medium_GroupA_GroupB) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Medium_GroupA_GroupB.Merge(m, src)
}
...
func (*Large) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{2}
}
...
func (*Labeled) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{3}
}
...
func (m *Labeled) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Labeled.Merge(m, src)
}
...
func (*WithMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc59b8948ca41db7, []int{4}
}
...
func (m *WithMap) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WithMap.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/python/util/protobuf/compare_test.proto", fileDescriptor_fc59b8948ca41db7)
}

var fileDescriptor_fc59b8948ca41db7 = []byte{
