...
func (ModelType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_813a9b946e06cd0d, []int{0}
}
...
func (*ModelConfigList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_813a9b946e06cd0d, []int{1}
}
...
func (*ModelServerConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_813a9b946e06cd0d, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/model_server_config.proto", fileDescriptor_model_server_config_813a9b946e06cd0d)
}

var fileDescriptor_model_server_config_813a9b946e06cd0d = []byte{
