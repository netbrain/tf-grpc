...
func (*Resource) Descriptor() ([]byte, []int) {
	return fileDescriptor_resources_c4b9e6361b87a98b, []int{0}
}
...
func (*ResourceAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_resources_c4b9e6361b87a98b, []int{1}
}
...
func (dst *ResourceAllocation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceAllocation.Merge(dst, src)
}
...
func (*ResourceAllocation_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_resources_c4b9e6361b87a98b, []int{1, 0}
}
...
func (dst *ResourceAllocation_Entry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceAllocation_Entry.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/resources/resources.proto", fileDescriptor_resources_c4b9e6361b87a98b)
}

var fileDescriptor_resources_c4b9e6361b87a98b = []byte{
