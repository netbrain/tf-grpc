...
func (*SignatureDefMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_aeb5b0fa8557969e, []int{0}
}
...
func (*GetModelMetadataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_aeb5b0fa8557969e, []int{1}
}
...
func (*GetModelMetadataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_aeb5b0fa8557969e, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_metadata.proto", fileDescriptor_get_model_metadata_aeb5b0fa8557969e)
}

var fileDescriptor_get_model_metadata_aeb5b0fa8557969e = []byte{
