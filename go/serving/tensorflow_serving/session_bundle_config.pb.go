...
func (*SessionBundleConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_55489498c94c6c2b, []int{0}
}
...
func (m *SessionBundleConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SessionBundleConfig.Merge(m, src)
}
...
func (*BatchingParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_55489498c94c6c2b, []int{1}
}
...
func (m *BatchingParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchingParameters.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/servables/tensorflow/session_bundle_config.proto", fileDescriptor_55489498c94c6c2b)
}

var fileDescriptor_55489498c94c6c2b = []byte{
