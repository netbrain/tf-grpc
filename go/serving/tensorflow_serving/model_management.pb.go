...
func (*ReloadConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_be21faea3addf69e, []int{0}
}
...
func (*ReloadConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_be21faea3addf69e, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_management.proto", fileDescriptor_model_management_be21faea3addf69e)
}

var fileDescriptor_model_management_be21faea3addf69e = []byte{
