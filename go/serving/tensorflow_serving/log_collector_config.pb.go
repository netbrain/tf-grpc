...
func (*LogCollectorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_collector_config_bc22aed346b8337b, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/log_collector_config.proto", fileDescriptor_log_collector_config_bc22aed346b8337b)
}

var fileDescriptor_log_collector_config_bc22aed346b8337b = []byte{
