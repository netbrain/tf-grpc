...
func (*Config1) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_6b760f04ca3229d9, []int{0}
}
...
func (*Config2) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_6b760f04ca3229d9, []int{1}
}
...
func (*MessageWithAny) Descriptor() ([]byte, []int) {
	return fileDescriptor_class_registration_test_6b760f04ca3229d9, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/util/class_registration_test.proto", fileDescriptor_class_registration_test_6b760f04ca3229d9)
}

var fileDescriptor_class_registration_test_6b760f04ca3229d9 = []byte{
