...
func (*SessionBundleSourceAdapterConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3142efd886a21ff, []int{0}
}
...
func (m *SessionBundleSourceAdapterConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SessionBundleSourceAdapterConfig.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/servables/tensorflow/session_bundle_source_adapter.proto", fileDescriptor_d3142efd886a21ff)
}

var fileDescriptor_d3142efd886a21ff = []byte{
