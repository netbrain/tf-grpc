...
func (HashmapSourceAdapterConfig_Format) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_hashmap_source_adapter_a4eb4744ec04068b, []int{0, 0}
}
...
func (*HashmapSourceAdapterConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_hashmap_source_adapter_a4eb4744ec04068b, []int{0}
}
...
func (dst *HashmapSourceAdapterConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HashmapSourceAdapterConfig.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/servables/hashmap/hashmap_source_adapter.proto", fileDescriptor_hashmap_source_adapter_a4eb4744ec04068b)
}

var fileDescriptor_hashmap_source_adapter_a4eb4744ec04068b = []byte{
