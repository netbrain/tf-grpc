...
func (*ClassifyLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{0}
}
...
func (*RegressLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{1}
}
...
func (*PredictLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{2}
}
...
func (*MultiInferenceLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{3}
}
...
func (*SessionRunLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{4}
}
...
func (*PredictionLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_3b0d73897663b1af, []int{5}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/prediction_log.proto", fileDescriptor_prediction_log_3b0d73897663b1af)
}

var fileDescriptor_prediction_log_3b0d73897663b1af = []byte{
